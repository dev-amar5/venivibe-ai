...
from schemas.admin_notifications import *
...
#     db: Session,
#     skip: int = 0,
#     limit: Optional[int] = None,  # now optional
...
#         params["since"] = since
#
#     # Popup case — only unseen alerts, limit 1
#     if popup:
#         query += " AND aa.is_seen = FALSE"
#         query += " ORDER BY aa.created_at DESC LIMIT 1"
#     else:
#         # Default (no limit → return all)
#         query += " ORDER BY aa.created_at DESC"
#         if limit:  # only apply if user passed a limit manually
