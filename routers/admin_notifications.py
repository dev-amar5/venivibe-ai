...
if __name__ == "__main__":
    a={"alert_type":"Multiple Failed Logins", "login_fail_count":21}
    # print(build_alert_response(a))
    # print(get_alert_details(alert_id='d241f87e-2694-4d4b-a599-2d7dd2a5d41a', db=db))
